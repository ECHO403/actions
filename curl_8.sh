...
build_arm() {
  ...
  make && make install 
  ./configure --host arm-linux-androideabi --with-pic --disable-shared --with-openssl --prefix=/tmp/curl/${arch}
  make && make install 
  make clean
}
...
build_x86_64() {
  ...
  make && make install 
  ./configure --host x86_64 --with-pic --disable-shared --with-openssl --prefix=/tmp/curl/${arch}
  make && make install 
  make clean
}
